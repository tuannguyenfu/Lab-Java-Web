...
public class RouterFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (url.endsWith(".jsp")) {
            if (url.contains("FindUs.jsp")) {
                httpRespond.sendRedirect("InforControl");
            }else if(url.contains("MenuAndListPrice.jsp")){
                httpRespond.sendRedirect("MenuAndListPrice");
            }else{
                httpRespond.sendRedirect("HomeControl");
            }
        }
